...
// Fallback colors when dynamic color is not available
// Based on a teal/green seed color suitable for radio/communication apps
...
val md_theme_dark_tertiary = Color(0xFFAACAE8)
val md_theme_dark_onTertiary = Color(0xFF10344B)
val md_theme_dark_tertiaryContainer = Color(0xFF2B4A62)
